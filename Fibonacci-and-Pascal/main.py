...
def test_printNumbers():
    ...
    assert printNumbers(10946)  == '1 19 153 680 1820 3003 3003 1716 495 55 1'
    assert printNumbers(317811) == '1 26 300 2024 8855 26334 54264 77520 75582 48620 19448 4368 455 14'
